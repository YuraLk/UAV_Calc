...
func Connect() {
	...
	db.AutoMigrate(&models.User{}, &models.Session{}, &models.Access{}, &models.Trial{}, &models.Linkage{}, &models.Frame{}, &models.Environment{}, &models.Attachments{}, &models.Manufacturer{}, &models.Model{}, &models.Motor{}, &models.Propeller{}, &models.Layout{}, &models.Controller{}, &models.Composit{}, &models.Battery{}, &models.Assembly{})
	DB = db
