...
type Controller struct {
	...
	Current            json.RawMessage `json:"currentRange" gorm:"type:jsonb;not null"`       // Диапазон сил тока. Номинальная сила тока - 80% от максимальной. Ограничивает подаваемый ток на двигатель. В случае объединенного контроллера, сила тока на один выход делится на количество выходов под один двигатель
